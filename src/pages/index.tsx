    ...
    <div className="mx-10 my-5">
      ...
      <div className="flex justify-center pt-[50px] h-full">
        <div className="flex flex-col text-center">
          <h1 className="font-black text-8xl ">Jon4s</h1>
          <h2 className="font-medium pt-[5px] text-xl text-subtext">Portugal, Aveiro</h2>
          <p className="text-2xl font-normal pt-[15px] text-subtext">Web Developer • Student</p>
